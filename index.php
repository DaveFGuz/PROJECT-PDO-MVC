...
<body class="cover" style="background-image: url(vistas/assets/img/loginFont.jpg);">
	<form action="vistas/plantilla.php" method="" autocomplete="off" class="full-box logInForm">
